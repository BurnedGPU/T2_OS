...
void update_elo(Player* p1, Player* p2, int match_result) {
    ...
    // calcula la formula de expectativa tanto para p1 como para p2
    ...
    //modifica los datos segun el resultado de la partida
    // modifica el elo segun la formula y adicionalmente agrega las victorias, derrotas y empates correspondientes
